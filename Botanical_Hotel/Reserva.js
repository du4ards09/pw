...
function calcular(){
    ...
    switch(slcSuiteValue){
        ...
        case "4":
            valorDiaria = 530.00;
            document.getElementById('nomeProduto').innerHTML = "Hideaway Villa Suite";
        ...
        case "5":
            valorDiaria = 600.00;
            document.getElementById('nomeProduto').innerHTML = "Botanical Villa";
        ...
        case "6":
            valorDiaria = 700.00;
            document.getElementById('nomeProduto').innerHTML = "Botanical Villa com piscina de imersão";
